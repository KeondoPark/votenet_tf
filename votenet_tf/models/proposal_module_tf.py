...
def decode_scores(net, aggregated_vote_xyz, aggregated_vote_inds, va_grouped_features, num_class, num_heading_bin, num_size_cluster, mean_size_arr):
    ...
    size_residuals = size_residuals_normalized * tf.expand_dims(tf.expand_dims(tf.cast(mean_size_arr,dtype=tf.float32), axis=0), axis=0)
...
class ProposalModule(layers.Layer):
    ...
    def call(self, xyz, features, end_points):
        ...
        #end_points['aggregated_v1te_xyz'] = xyz # (batch_size, num_proposal, 3)
