...
class TransformerDecoderLayer(tf.keras.layers.Layer):
    def __init__(self, d_model=288, nhead=8, dim_feedforward=2048, dropout=0.1,
        ...
        self.linear1 = layers.Dense(dim_feedforward, kernel_initializer=tf.keras.initializers.he_normal())
        self.dropout = layers.Dropout(dropout)
        self.linear2 = layers.Dense(d_model, kernel_initializer=tf.keras.initializers.he_normal())
