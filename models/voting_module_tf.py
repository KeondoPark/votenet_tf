...
class VotingModule(layers.Layer):
    def __init__(self, vote_factor, seed_feature_dim, model_config):
        ...
        if self.use_tflite:
            ...
            self.conv3 = layers.Conv1D(filters=(self.out_dim+3) * self.vote_factor, kernel_size=1)
    ...
    def call(self, seed_xyz, seed_features):
        ...
        if self.use_tflite:
            ...
            net = layers.Reshape((num_seed, self.vote_factor, 3 + self.out_dim))(net) # (batch_size, num_seed, vote_factor, out_dim)        
