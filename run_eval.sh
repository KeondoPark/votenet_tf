...
--batch_size 16 --ap_iou_thresholds 0.25 --faster_eval \
--config_path configs/config_gf_2way.json --size_cls_agnostic
...
# --use_3d_nms --use_cls_nms --per_class_proposal \
# --batch_size 16 --ap_iou_thresholds 0.25 --faster_eval \
# --config_path configs/config_gf_scannet_2way.json
