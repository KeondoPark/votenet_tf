...
do    
    ...
    #2way tpu
    python3 demo_tf.py --config_path configs/inf_scannet_2way_nofp_sep.json --gpu_mem_limit 256 --inf_time_file=jetson_inf_time/inf_scannet_2way_nofp_sep_single.log
