...
${CUDA_ROOT}/bin/nvcc -std=c++11 -c -o tf_interpolate.cu.o tf_interpolate.cu ${TF_CFALGS[@]} -D GOOGLE_CUDA=1 -x cu -Xcompiler -fPIC
g++ -std=c++11 -shared -o tf_interpolate_so.so tf_interpolate.cpp tf_interpolate.cu.o ${TF_CFLAGS[@]} -fPIC -L${CUDA_ROOT}/lib64 -lcudart ${TF_LFLAGS[@]} -I ${CUDA_ROOT}/include
