...
# sunrgbd 1way
CUDA_VISIBLE_DEVICES=0 python train_tf.py --config_path configs/config_gf_1way.json \
                       --max_epoch 300 --lr-scheduler cosine \
                       --size_cls_agnostic --size_delta 0.0625 --heading_delta 0.04 --center_delta 0.1111111111111 \
                       --num_point 20000 --num_decoder_layers 6 \
                       --learning_rate 0.004 --decoder_learning_rate 0.0002 --weight_decay 0.00005 \
...
# sunrgbd 2way
CUDA_VISIBLE_DEVICES=0 python train_tf.py --config_path configs/config_gf_2way.json \
...
# scannet 1way
CUDA_VISIBLE_DEVICES=0 python train_tf.py --config_path configs/config_gf_scannet_1way.json \
                       --num_point 50000 --num_decoder_layers 6 --size_delta 0.1111111111 --center_delta 0.04 \
                       --learning_rate 0.006 --decoder_learning_rate 0.0006 --weight_decay 0.0005 --optimizer adamw \
                       --lr_decay_rates 0.1,0.1 --lr_decay_steps 210,255 \
                       --decoder_lr_decay_rates 0.1,0.1 --decoder_lr_decay_steps 210,255
...
# scannet 2way
CUDA_VISIBLE_DEVICES=1 python train_tf.py --config_path configs/config_gf_scannet_2way.json \
                       --num_point 50000 --num_decoder_layers 6 --size_delta 0.1111111111 --center_delta 0.04 \
                       --learning_rate 0.006 --decoder_learning_rate 0.0006 --weight_decay 0.0005 --optimizer adamw \
                       --lr-scheduler cosine --cosine_alpha 0.01 --batch_size 16

# scannet 2way step lr schedule
CUDA_VISIBLE_DEVICES=0 python train_tf.py --config_path configs/config_gf_scannet_2way_random_split.json \
                       --num_point 50000 --num_decoder_layers 6 --size_delta 0.1111111111 --center_delta 0.04 \
                       --learning_rate 0.006 --decoder_learning_rate 0.0006 --weight_decay 0.0005 --optimizer adamw \
...
# Tuning
CUDA_VISIBLE_DEVICES=0 python train_tf.py --config_path configs/config_gf_scannet_2way.json \
